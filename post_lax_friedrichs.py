...
def animate_3d(grid, num_t, dt, memmap_object):
    ...
    ani.save(r'graphs/animation.mp4', dpi = 300, writer = 'ffmepg')
...
def main():
    ...
    data_memmap = np.memmap(rf'data/data{int(x_int_len/step_x)}x{int(y_int_len/step_y)}.dat', dtype = 'float32', mode = 'r', shape = (int(x_int_len/step_x),int(y_int_len/step_y), num_t_steps+1))
